...
/*  on mouse hover elements functions start  */

// document.addEventListener('mousemove', (event) => {

//   console.log(`Mouse X: ${event.clientX}, Mouse Y: ${event.clientY}`);
  
//   $('.b1').css('left',640 + `${event.clientX}` / 10);
//   $('.b1').css('top',450 + `${event.clientY}` / 10);

//   $('.b2').css('left',380 - `${event.clientX}` / 8);
//   $('.b2').css('top',435 + `${event.clientY}` / 8);

//   $('.b3').css('left',-30 - `${event.clientX}` / 20);
//   $('.b3').css('top',170 + `${event.clientY}` / 20);

//   $('.b4').css('left',29 + `${event.clientX}` / 15);
//   $('.b4').css('top',410 + `${event.clientY}` / 15);
  
//   $('.b5').css('left',150 + `${event.clientX}` / 20);
//   $('.b5').css('top',198 + `${event.clientY}` / 20);

//   $('.b6').css('left',994 + `${event.clientX}` / 10);
//   $('.b6').css('top',204 + `${event.clientY}` / 10);
  
//   $('.b7').css('left',1150 - `${event.clientX}` / 8);
//   $('.b7').css('top',606 + `${event.clientY}` / 8);
  
//   $('.b8').css('left',559 - `${event.clientX}` / 25);
//   $('.b8').css('top',507 + `${event.clientY}` / 25);
...
/*  on mouse hover elements functions end  */
...
$('.tab-custom ').click(function(event){
...
$(document).scroll(function () {
    ...
    // if (y > 500) {
    //   $('.floatingform-sec').addClass('visible');
    //     $('.btns_wrap').addClass('visible');
        
        
    // } else {
    //   $('.floatingform-sec').removeClass('visible');
    //     $('.btns_wrap').removeClass('visible');
